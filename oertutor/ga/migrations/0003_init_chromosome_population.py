...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for chromosome in orm.Chromosome.objects.all():
            mem = orm.GenerationMembership.objects.filter(
                    chromosome=chromosome)[0]
            population = mem.generation.population
            chromosome.population=population
            chromosome.save()

    def backwards(self, orm):
        print "Cannot reverse this migration, moving on"
