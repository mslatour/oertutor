...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.preskill'
        db.add_column(u'tutor_student', 'preskill',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Student.postskill'
        db.add_column(u'tutor_student', 'postskill',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Student.comments'
        db.add_column(u'tutor_student', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.preskill'
        db.delete_column(u'tutor_student', 'preskill')

        # Deleting field 'Student.postskill'
        db.delete_column(u'tutor_student', 'postskill')

        # Deleting field 'Student.comments'
        db.delete_column(u'tutor_student', 'comments')
