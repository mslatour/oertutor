...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BootstrapEvaluation'
        db.create_table(u'tutor_bootstrapevaluation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sequence', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['tutor.StudentCategory'])),
            ('trial', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['tutor.Trial'])),
        ...
        db.send_create_signal(u'tutor', ['BootstrapEvaluation'])


    def backwards(self, orm):
        # Deleting model 'BootstrapEvaluation'
        db.delete_table(u'tutor_bootstrapevaluation')
    ...
    models = {
        ...
        u'tutor.bootstrapevaluation': {
            'Meta': {'object_name': 'BootstrapEvaluation'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['tutor.StudentCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sequence': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'trial': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['tutor.Trial']"}),
